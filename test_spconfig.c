...
bool test_hasNoWhiteSpace() {
	 ASSERT_TRUE (0== hasNoWhiteSpace(" D"));
	 ASSERT_TRUE (0== hasNoWhiteSpace("d D"));
	 ASSERT_TRUE (0== hasNoWhiteSpace("D "));
	 ASSERT_TRUE (0== hasNoWhiteSpace(" "));
	 ASSERT_TRUE (1== hasNoWhiteSpace("dD"));
	 ASSERT_TRUE (1== hasNoWhiteSpace(""));
	 return true;
}


bool test_validSuffix() {
	ASSERT_TRUE(validSuffix(".gif") == 1);
	ASSERT_TRUE(validSuffix(".jpg") == 1);
	ASSERT_TRUE(validSuffix(".png") == 1);
	ASSERT_TRUE(validSuffix(".bmp") == 1);
	ASSERT_TRUE(validSuffix(".bmpf") == 0);
	ASSERT_TRUE(validSuffix("f.bmp") == 0);
	ASSERT_TRUE(validSuffix("") == 0);
	return true;
}


bool test_isInteger(){
	ASSERT_TRUE(1== isInteger("1"));
	ASSERT_TRUE(1== isInteger("+1"));
	ASSERT_TRUE(1== isInteger("-1"));
	ASSERT_TRUE(0== isInteger("1213+675"));
	ASSERT_TRUE(0== isInteger("1."));
	ASSERT_TRUE(0== isInteger("1as"));
	ASSERT_TRUE(0== isInteger("+s"));
	ASSERT_TRUE(0== isInteger("1.0"));
	return true;
}

bool test_isPositiveInteger() {
	ASSERT_TRUE(1== isPositiveInteger("12"));
	ASSERT_TRUE(1== isPositiveInteger("0"));
	ASSERT_TRUE(1== isPositiveInteger("+3"));
	ASSERT_TRUE(0== isPositiveInteger("+"));
	ASSERT_TRUE(0== isPositiveInteger("-"));
	ASSERT_TRUE(0== isPositiveInteger("-2"));
	ASSERT_TRUE(0== isPositiveInteger("1.2"));
	ASSERT_TRUE(0== isPositiveInteger("1.0"));
	ASSERT_TRUE(0== isPositiveInteger("s"));
	return true;
}


bool tewst_isNotNegativeInteger() {
	ASSERT_TRUE(1== isNotNegativeInteger("12"));
	ASSERT_TRUE(0== isNotNegativeInteger("0"));
	ASSERT_TRUE(1== isNotNegativeInteger("+3"));
	ASSERT_TRUE(0== isNotNegativeInteger("+"));
	ASSERT_TRUE(0== isNotNegativeInteger("-"));
	ASSERT_TRUE(0== isNotNegativeInteger("-2"));
	ASSERT_TRUE(0== isNotNegativeInteger("1.2"));
	ASSERT_TRUE(0== isNotNegativeInteger("s"));
	return true;
}


bool test_isInRange() {
	ASSERT_TRUE(1==isInRange("1",0,2));
	ASSERT_TRUE(1==isInRange("1",1,1));
	ASSERT_TRUE(1==isInRange("1",1,1));
	ASSERT_TRUE(1==isInRange("-1",-1,1));
	ASSERT_TRUE(0==isInRange("1.1",0,2));
	ASSERT_TRUE(0==isInRange("-1",0,2));
	ASSERT_TRUE(0==isInRange("+3",0,2));
	ASSERT_TRUE(0==isInRange("1.0",0,2));
	return true;
}

bool test_getTreeSplitMethod() {
	ASSERT_TRUE(0==getTreeSplitMethod("RANDOM"));
	ASSERT_TRUE(1==getTreeSplitMethod("MAX_SPREAD"));
	ASSERT_TRUE(2==getTreeSplitMethod("INCREMENTAL"));
	ASSERT_TRUE(-1==getTreeSplitMethod("MAX_SPREAd"));
	ASSERT_TRUE(-1==getTreeSplitMethod("MAX_SPR"));
	ASSERT_TRUE(-1==getTreeSplitMethod("SPLIT_METHOD_COUNT"));
	return true;
}

bool test_isBoolean() {
	ASSERT_TRUE(1==isBoolean("true"));
	ASSERT_TRUE(0==isBoolean("false"));
	ASSERT_TRUE(-1==isBoolean("fdalse"));
	ASSERT_TRUE(-1==isBoolean(""));
	return true;
}

bool test_getBoolean() {
	ASSERT_TRUE(true == getBoolean("true"));
	ASSERT_TRUE(false == getBoolean("false"));
	return true;
}

bool test_isLoggerLevel(){
	ASSERT_TRUE(isLoggerLevel("1")==1);
	ASSERT_TRUE(isLoggerLevel("2")==1);
	ASSERT_TRUE(isLoggerLevel("4")==1);
	ASSERT_TRUE(isLoggerLevel("3")==1);
	ASSERT_TRUE(isLoggerLevel("ERRORR")==0);
	ASSERT_TRUE(isLoggerLevel("5")==0);
	return true;
}
...
bool test_trimWhitespace(){
	...
	ASSERT_TRUE(strcmp(left, "aa") == 0);
    left_temp = " ";
	ASSERT_TRUE(strcmp(left, "") == 0);
    left_temp = " s s ";
	ASSERT_TRUE(strcmp(left, "s s") == 0);
    left_temp = "ss";
	ASSERT_TRUE(strcmp(left, "ss") == 0);
    left_temp = "";
	ASSERT_TRUE(strcmp(left, "") == 0);
	return true;
}
...
bool test_splitEqualAndTrim(){
    ...
    ASSERT_TRUE(strcmp(left, "asd")==0);
    ASSERT_TRUE(strcmp(right, "")==0);
    ...
    splitEqualAndTrim(line, left, 1024, right, 1024);
    ASSERT_TRUE(strcmp(left, "")==0);
    ASSERT_TRUE(strcmp(right, "asd")==0);
    
    line = "as= d";
    splitEqualAndTrim(line, left, 1024, right, 1024);
    ASSERT_TRUE(strcmp(left, "as")==0);
    ASSERT_TRUE(strcmp(right, "d")==0);
...
bool test_spConfigCreate(){
    ...
    ASSERT_TRUE(spConfigGetNumOfImages(config, &msg) == 100);
    ASSERT_TRUE(msg == SP_CONFIG_SUCCESS);  

    ASSERT_TRUE(spConfigGetNumOfFeatures(config, &msg) == 101);
    ASSERT_TRUE(msg == SP_CONFIG_SUCCESS);  

    ASSERT_TRUE(spConfigGetPCADim(config, &msg) == 28);
    ASSERT_TRUE(msg == SP_CONFIG_SUCCESS);  
    ...
    ASSERT_TRUE(strcmp(imagePath, "test1.log") == 0);
    printf("%s\n", imagePath);
    spConfigDestroy(config);
    return true;
