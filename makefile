...
OBJS = SPListElement.o SPList.o SPBPriorityQueue.o SPLogger.o SPPoint.o SPConfig.o  SPImageProc.o SPExtractFeatures.o SPKDArray.o KDTreeNode.o main_aux.o main.o
